...
public class MS_ARCR {
	...
	String dirkeynameptl = "arcr_ptl";
	String dirkeynameptr = "arcr_ptr";
	String dirkeynamedl = "arcr_dl";
	String dirkeynamedr = "arcr_dr";
	String dirkeynameptdb = "arcr_target";
		...
		return new ChangeListener<String>() {
			...
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
		        ...
		        //check if everything is filled out
		        	...
		        	if(txt_input_ld.textProperty().length().isEqualTo(4).get()) {
		        		dl = Integer.valueOf(txt_input_ld.textProperty().get());
		        	}else{
		        		dl=-1;
		        	};
		        	
		        	if(txt_input_rd.textProperty().length().isEqualTo(4).get()) {
	...
	private void initialize() {		
		...
		if(!tmp.isBlank()) {
			...
			txt_input_ld.setText(String.format("%04d" , dl));
		...
		if(!tmp.isBlank()) {
			...
			txt_input_rd.setText(String.format("%04d" , dr));
		...
		btn_lfromdb.setOnAction((e)->{
			...
			DB.setTransferDestination(SceneDirectory.MS_ARCR);
